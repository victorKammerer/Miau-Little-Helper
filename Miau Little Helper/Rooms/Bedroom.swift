...
extension GameScene {
    ...
    var shelfWall : SKSpriteNode {
        ...
        shelfWall.position = CGPoint(x: shelfWall.frame.width/2 + 200, y: shelfWall.frame.height/2 + 2050)
...
//        let clothesObstacle = SKSpriteNode(color: .cyan, size: CGSize(width: 400, height: 400))
